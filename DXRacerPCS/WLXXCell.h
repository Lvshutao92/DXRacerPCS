...
@interface WLXXCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *heig;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *youfeitop;
