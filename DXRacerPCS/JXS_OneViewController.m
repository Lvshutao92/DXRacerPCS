...
@interface JXS_OneViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
{
    NSInteger totalnum;
    NSInteger page;
}
...
@implementation JXS_OneViewController
...
- (BOOL)searchBarShouldBeginEditing:(UISearchBar *)searchBar{
    JXS_One_Search_ViewController *search = [[JXS_One_Search_ViewController alloc]init];
