//
//  Order_Srearch_List_ViewController.m
//  DXRacerPCS
//
...
@interface Order_Srearch_List_ViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
{
    NSInteger totalnum;
    NSInteger page;
...
@implementation Order_Srearch_List_ViewController
...
- (void)loddeList{
    ...
    dic = @{@"business_id":[Manager redingwenjianming:@"business_id.text"],
            ...
            @"order_no":self.str1,
            @"partner_name":self.str2,
            @"sku_code":self.str3,
            @"order_resource_num":self.str4,
            @"express_order":self.str5,
            @"jxs_order_status":self.str6,
            @"deliver_start_time":self.str7,
            @"deliver_start_time":self.str8,
